 ...
 */
public class EclipselinkAnnotationIntrospector extends AnnotationIntrospector {
    ...
    public EclipselinkAnnotationIntrospector() {
    }
     ...
     */
    public EclipselinkAnnotationIntrospector setUseTransient(boolean state) {
    ...
    public Boolean isIgnorableType(AnnotatedClass ac) {
        /* 26-Dec-2015, tatu: To fix [datatype-eclipselink#72], need to suppress handling
         *  of `FieldHandled`. Not sure if it works without test (alas, none provided),
         *  but will try our best -- problem is, if it'
         */
        // 11-Feb-2016, tatu: As per [datatype-eclipselink#86] must use indirection. Sigh.
    ...
    final static class FieldHandlerChecker {
        ...
        private final static String FIELD_HANDLER_INTERFACE = "org.eclipselink.bytecode.internal.javassist.FieldHandler";
