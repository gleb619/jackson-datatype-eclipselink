...
import com.fasterxml.jackson.datatype.eclipselink.EclipselinkModule.Feature;
...
public class PersistentCollectionSerializer extends ContainerSerializer<Object> implements ContextualSerializer, ResolvableSerializer {
    ...
    public PersistentCollectionSerializer(JavaType containerType, JsonSerializer<?> serializer, int features) {
        super(containerType);
    ...
    public boolean isEmpty(Object value) {
        ...
        if (value instanceof IndirectCollection) {
            Object lazy = findLazyValue((IndirectCollection) value);
    ...
    public void serialize(Object value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
        if (value instanceof IndirectCollection) {
            value = findLazyValue((IndirectCollection) value);
            if (value == null) {
        ...
        if (_serializer == null) { // sanity check...
            throw JsonMappingException.from(jgen, "IndirectCollection does not have serializer set");
        }

        // 30-Jul-2016, tatu: wrt [datatype-eclipselink#93], should NOT have to do anything here;
    ...
    public void serializeWithType(Object value, JsonGenerator jgen, SerializerProvider provider, TypeSerializer typeSer) throws IOException {
        ...
        // 30-Jul-2016, tatu: wrt [datatype-eclipselink#93], conversion IS needed here (or,
        ...
        if (Feature.REPLACE_PERSISTENT_COLLECTIONS.enabledIn(_features)) {
            value = convertToJavaCollection(value); // Strip IndirectCollection
        }
    ...
    protected Object findLazyValue(IndirectCollection collection) {
        // If lazy-loaded, not yet loaded, may serialize as null
        if (Feature.FORCE_LAZY_LOADING.disabledIn(_features) && Objects.isNull(collection.getDelegateObject())) {
            return null;
        }
//        if (_sessionFactory != null) {
////            Sorry about that, i leave this block blank
//        }
    ...
    protected boolean usesLazyLoading(BeanProperty property) {
        if (property != null) {
            ...
            // As per [Issue#53]
            return Feature.REQUIRE_EXPLICIT_LAZY_LOADING_MARKER.disabledIn(_features);
        }
        return false;
    }
    ...
    private Object convertToJavaCollection(Object value) {
        ...
        throw new IllegalArgumentException("Unsupported IndirectCollection subtype: " + value.getClass());
    }
